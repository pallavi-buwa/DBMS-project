...
<html>
    ...
    <body  class="bg-img">
      <nav class="navbar navbar-inverse navbar-fixed-top">
        ...
        <br>
        <br>
        <center><h2>Patient Record</h2></center>
        
        <?php
        
        $num= mysqli_real_escape_string($con,$_POST['aad_num']);
        $selectq="SELECT * FROM patient where aadhaar='$num'";
        ...
        <?php
            echo "<a href='search_pt.php' style='color: blue'>Back</a>";
        }
